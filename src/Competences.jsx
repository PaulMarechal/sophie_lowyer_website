    ...
    return(
        <>
            <div style={{width: '100%', height: '90vh',}}>
                ...
                <section className="first_section" id="a_propos_section" style={{background: '#007BEE', paddingTop: '20vh'}}>
                    <h1 className="first_section_h1_comptetences">
                        <span className="quote_style" style={{left:'-1vh'}}>,,</span>
                    ...
                    <h1 className="first_section_h1_comptetences" style={{paddingTop:' 0vh'}}>
