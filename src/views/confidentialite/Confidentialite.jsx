                ...
                <section className="fourth_section" id="honoraires_section">
                    ...
                    <div className="display_text_elem_others_pages_div">
                        ...
                        <div className="contact_part_others_pages confidentialite_second_div">
                            <div>
                                <p className={styles.asideLabel}>Le cabinet</p>
                                <p className={styles.asideText}>Pour toute question relative au traitement des données personnelles, vous pouvez joindre directement le cabinet.</p>
