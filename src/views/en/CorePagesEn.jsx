      ...
      <section className={styles.content}>
        ...
        <section className={styles.sideCard}>
          ...
          <div className={practiceStyles.expertiseGrid}>
            ...
            <Link href="/en/public-service-law" className={practiceStyles.expertiseItem}><div className={practiceStyles.expertiseImage}><Image src="/Images/droit-fonction-publique-marianne.webp" alt="" fill sizes="(max-width: 640px) calc(100vw - 5rem), (max-width: 1200px) calc(50vw - 5rem), 520px" /></div><span>Public service law</span></Link>
      ...
      <section className={styles.contentSection}>
        ...
        <article className={styles.displayCard}>
          ...
          <div className={styles.expertiseGrid}>
            <Link href="/en/planning-law" className={styles.expertiseItem}><div className={styles.expertiseImage}><Image src="/Images/droit_urbanisme.webp" alt="" fill sizes="(max-width: 640px) calc(100vw - 5rem), (max-width: 1200px) calc(50vw - 5rem), 520px" /></div><span>Planning law</span></Link>
            <Link href="/en/talent-passport-resident-card-lawyer-paris" className={styles.expertiseItem}><div className={styles.expertiseImage}><Image src="/Images/droit-des-etrangers-passeports.webp" alt="" fill sizes="(max-width: 640px) calc(100vw - 5rem), (max-width: 1200px) calc(50vw - 5rem), 520px" /><PhotoCredit language="en" /></div><span>Immigration law</span></Link>
            <Link href="/en/public-service-law" className={styles.expertiseItem}><div className={styles.expertiseImage}><Image src="/Images/droit-fonction-publique-marianne.webp" alt="" fill sizes="(max-width: 640px) calc(100vw - 5rem), (max-width: 1200px) calc(50vw - 5rem), 520px" /></div><span>Public Service Law Attorney</span></Link>
            <Link href="/en/french-nationality-law" className={styles.expertiseItem}><div className={styles.expertiseImage}><Image src="/Images/paris_monument.jpg" alt="" fill sizes="(max-width: 640px) calc(100vw - 5rem), (max-width: 1200px) calc(50vw - 5rem), 520px" /></div><span>French nationality law</span></Link>
          </div>
        </article>
      </section>
    </div>
